...
//The libraries and Constant values of keys
...
//The blockchain (Transaction, blocks , difficulty ,time , reward)
class Blockchain {
    constructor() {
...
module.exports = { Block, Transaction, Blockchain, chain };